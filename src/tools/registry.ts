...
import { getBrazilBonds } from './finance/brazil-bonds.js';
...
import { BRAZIL_BONDS_DESCRIPTION } from './descriptions/brazil-bonds.js';
...
export function getToolRegistry(model: string): RegisteredTool[] {
  const tools: RegisteredTool[] = [
    ...
    },
    {
      ...
      tool: getBrazilBonds,
      description: BRAZIL_BONDS_DESCRIPTION,
    },
    {
